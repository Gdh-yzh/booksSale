	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> <span class="little_n">
					| <a href="#" name="mydangdang" class="head_black12a">我的淘书斋</a> | <a
					href="${pageContext.request.contextPath}/common/introduce.jsp" name="helpcenter" class="head_black12a" >帮助</a>
					| </span> </span>
			<div class="cart gray4012">
				<a href="${pageContext.request.contextPath}/car.do?method=4">购物车</a>
			</div>
		</div>
		...
		[&nbsp;<a href="<%=request.getContextPath() %>/user/logout.do" class="b">登出</a>&nbsp;]
		<%} else{%>
		
		[&nbsp;<a href="${pageContext.request.contextPath}/user/login.do?method=0" class="b">登录</a>|<a
			href="${pageContext.request.contextPath}/user/regist.do?method=0" class="b">注册</a>&nbsp;]
		<%} %>
		</span>
	</div>
